...
epicsEnvSet("RECORD",    "NSLS2I_EM:")
epicsEnvSet("PORT",      "NSLS2I_EM")
epicsEnvSet("TEMPLATE",  "NSLS2I_EM")
...
dbLoadRecords("$(QUADEM)/db/NSLS2I_Ranges.template","P=$(PREFIX), R=$(RECORD),PORT=$(PORT),N=0")
dbLoadRecords("$(QUADEM)/db/NSLS2I_Ranges.template","P=$(PREFIX), R=$(RECORD),PORT=$(PORT),N=1")
dbLoadRecords("$(QUADEM)/db/NSLS2I_Ranges.template","P=$(PREFIX), R=$(RECORD),PORT=$(PORT),N=2")
dbLoadRecords("$(QUADEM)/db/NSLS2I_Ranges.template","P=$(PREFIX), R=$(RECORD),PORT=$(PORT),N=3")
